...
if [ "$CC_SRC_LANGUAGE" = "go" -o "$CC_SRC_LANGUAGE" = "golang" ] ; then
	...
	CC_SRC_PATH="../chaincode/emr/go/"

	echo Vendoring Go dependencies ...
	pushd ../chaincode/emr/go
	...
	CC_SRC_PATH="../emr/chaincode/"

elif [ "$CC_SRC_LANGUAGE" = "java" ]; then
	CC_RUNTIME_LANGUAGE=java
	CC_SRC_PATH="../chaincode/emr/java/build/install/emr"

	echo Compiling Java code ...
	pushd ../chaincode/emr/java
	./gradlew installDist
	popd
	...
	CC_RUNTIME_LANGUAGE=node # chaincode runtime language is node.js
	CC_SRC_PATH="../chaincode/emr/typescript/"

	echo Compiling TypeScript code into JavaScript ...
	pushd ../chaincode/emr/typescript
	npm install
	npm run build
	popd
...
#     set -x
#     peer chaincode query -C $CHANNEL_NAME -n emr -c '{"Args":["viewUnsoldProducts"]}' >&log.txt
#     res=$?
#     set +x
# 		let rc=$res
# 		COUNTER=$(expr $COUNTER + 1)
